      ...
      <section className="bg-gray-50">
        <div className="flex flex-col gap-y-4 items-center md:flex-row p-6">
          ...
          <div className="w-1/2 flex flex-col">
            ...
            <Paragraph>
              Facilite o gerenciamento de usuários com o looplex. Seus usuários
              terão acesso seguro e você poderá monitorar e controlar a
              atividade do usuário a partir de um local centralizado.
            </Paragraph>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col gap-y-4 items-center p-6">
          ...
          <div className="flex flex-wrap items-center justify-center md:flex-row gap-x-2">
            <div className="flex flex-col w-full md:w-[30%] text-center">
              ...
              <Paragraph>
                Ganhe confiança sabendo que seu sistema possui controle de
                acesso seguro com autenticação de dois fatores e outras medidas
                de segurança.
              </Paragraph>
            </div>
            ...
            <div className="flex flex-col w-full md:w-[30%] text-center">
              ...
              <Paragraph>
                Permita que os usuários personalizem rapidamente seus perfis e
                gerenciem os detalhes de suas contas de maneira segura e fácil
                de usar.
              </Paragraph>
            </div>
            ...
            <div className="flex flex-col w-full md:w-[30%] text-center">
              ...
              <Paragraph>
                Monitore a atividade do usuário em tempo real e garanta que o
                painel esteja sempre atualizado.
              </Paragraph>
            </div>
          </div>
        </div>
